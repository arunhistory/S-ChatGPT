...
static int initialGames(){ static const int g[9]={20,30,40,50,75,100,150,200,300}; static const double w[9]={.20,.25,.20,.15,.08,.06,.03,.025,.005}; double r=u01(),a=0;for(int i=0;i<9;++i){a+=w[i];if(r<a)return g[i];}return 300; }
static int addGames(){ static const int g[6]={10,20,30,50,100,200}; static const double w[6]={.30,.30,.20,.12,.06,.02}; double r=u01(),a=0;for(int i=0;i<6;++i){a+=w[i];if(r<a)return g[i];}return 200; }
...
static int upperChains(){ static const int g[11]={1,2,3,5,8,12,16,24,32,50,100}; static const double w[11]={.12,.10,.08,.08,.10,.12,.12,.11,.08,.05,.04}; double r=u01(),a=0;for(int i=0;i<11;++i){a+=w[i];if(r<a)return g[i];}return 100; }
