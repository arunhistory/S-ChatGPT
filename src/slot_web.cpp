...
static void resetState(uint64_t seed){memset(&s,0,sizeof(s));s.setting=7;s.tier=Lower;s.at_table=ATNormal;s.last_role=Miss;rng=seed?seed:0x5343484154475054ULL;rerollNormal();}
