...
static int initialGames(){
    if(setting6()){
        static const int g6[8]={20,30,40,50,75,100,150,200};
        static const double w6[8]={.20,.25,.20,.15,.08,.06,.035,.025};
        double r=u01(),a=0;for(int i=0;i<8;++i){a+=w6[i];if(r<a)return g6[i];}return 200;
    }
...
static int addGames(){
    ...
    static const double wex[6]={.30,.30,.20,.12,.06,.02};
    static const double w6[6]={.40,.30,.18,.08,.03,.01};
    const double* w=setting6()?w6:wex;
